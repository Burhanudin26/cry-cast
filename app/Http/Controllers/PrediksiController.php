...
class PrediksiController extends Controller
{
      ...
      public function HitungSMA($table)
      {
          ...
          // Prepare the SQL query to get the low, high, and volume values from the prediksi table in groups of 5
      ...
      public function Threshold($table)
      {
          ...
          // Prepare the SQL query to get the monthly averages of low, high, and volume from the prediksi table
      ...
      // treshold check based on threshold table per month and iterate to chech per day in prediksi table
      public function bayes($table)
      {
          ...
          foreach ($thresholds as $threshold) {
              ...
              // Get the prediksi data for the month
      ...
      public function import(Request $request)
      {
          ...
          if ($file && $file->isValid()) {
              ...
              $table = 'prediksi';
              DB::table('prediksi')->where('id', '<>', 'admin')->delete();
              foreach ($data as $row) {
          ...
          // get data as array from table prediksi and column low and column id
          $low_data = DB::table($table)->select('low')->get();
          $low_trend = DB::table('SMA')->select('sma_low')->get();
  
          // get data as array from table prediksi and column volume and column id
      ...
      // predict all data in table prediksi in save in table prediction
